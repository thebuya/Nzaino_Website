    ...
    <div>
      <div className="firstpart">
        <div className="behind">
          ...
          <div className="logos">
            <div
              className="logoscroll marquee--inner"
              style={{
        ...
        <div className="showff">
          ...
          <h3 className="partners" id="Partners">
            Trusted By:
          </h3>
        </div>
      </div>
        ...
        <div className="who">
          <div className="left">
            ...
            <p className="whotext">
              ...
              We are a team of passionate and knowledgeable experts who love to
              create{" "}
              <Link
              ...
              beauty and diversity of this amazing continent. Whether you are
              looking for adventure, business, romance, culture, or wildlife
              <span className="highlight">
                , we have something for everyone
              </span>
              . We tailor each safari to your personal preferences and
              interests, ensuring that you have the best experience possible.
              Join us and discover the wonders of Africa with Nzaino Travel
              Africa.
            </p>
          </div>
          ...
          <div className="teamswiper">
            ...
            <p className="caption">
              ...
              <Link
                ...
                className="linker"
                aria-label="Find an exciting East Africa travel destination."
                onClick={() => {
                  handleLinkClick();
                }}
              >
