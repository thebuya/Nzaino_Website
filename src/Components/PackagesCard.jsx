  ...
  return (
    <div className="packagesCard" key={props.id}>
      <div className="imageCaption">
        ...
        />
        <button className="prevButton" onClick={handleSwipeLeft}>
          <TiArrowLeft />
        </button>
        <button className="nextButton" onClick={handleSwipeRight}>
          <TiArrowRight />
        </button>
      ...
      <div className="packagesText">
        ...
        <h3 className="themeActivities">{props.activities}</h3>
        ...
        <div className="middlecolumns">
          ...
          <div className="miniItenary">
            <h3 className="highlights">Inclusive</h3>
            <ul>{highlights}</ul>
          </div>
        </div>
      </div>
      ...
      <button
        ...
        aria-label={`Book The ${props.title} trip package`}
      >
        Book Trip <TiArrowRight />{" "}
      </button>
    </div>
  );
}
