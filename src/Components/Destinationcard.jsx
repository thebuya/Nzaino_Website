    ...
    return (
            ...
            <div className="upperpart" key={props.id}>
                <div className="leftpart">
                    <div className="maini">
                        <img className='mainimagery' src={mainImage} alt="Beautiful East African Landscape"/>
                    </div>
...
/>
                    ...
                    <div className="secondary-info">
                        <div className="mini-leftpart">
                            <h3 className="subheading">
                                ...
                                <a href={props.download ? props.download : "#"} style={{ opacity: 0.5, fontSize: '13px' }}>
  {props.download ? "Download TravelGuide.pdf" : "Uploading in 14days"}
                    ...
                    <button onClick={scrollToSection}>Book This Trip <TiArrowRight/> </button>
                </div>
            </div>  
