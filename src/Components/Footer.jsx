    ...
    <footer>
      <div className="links_container">
        <div className="link_container location">
          ...
          <p>
            <BsGeoAltFill />
            Behind Nakawa PostOffice <br className="off-phone" />
        ...
        <div className="link_container contacts">
          ...
          <div className="footer-icons">
            <ul>
              <li>
                <a
                  aria-label="Visit Nzaino on Whatsapp"
                  rel="noreferrer"
                  href="https://wa.me/256772525312"
                  target="_blank"
                >
                  <FaWhatsapp />
                </a>
              ...
              <li>
                <a
                  aria-label="Visit Nzaino on facebook"
                  rel="noreferrer"
              ...
              <li>
                {" "}
                <a
                  aria-label="Visit Nzaino on twitter"
                  rel="noreferrer"
              ...
              <li>
                <a
                  aria-label="Visit Nzaino on instagram"
                  rel="noreferrer"
                  target="_blank"
          ...
          <ul>
            ...
            <li>
              ...
              <NavLink
                to="/#Testimonials"
                onClick={() => {
                    handleNavLinkClick("our clients reviews.");
                  }}
              >
                <TiArrowRight />
                Client Testimonials{" "}
            ...
            <li>
              ...
              <NavLink
                ...
                onClick={() => {
                    handleNavLinkClick("client questions.");
                  }}
              >
                <TiArrowRight />
                Client Questions
            ...
            <li>
              ...
              <NavLink
                to="/aboutnzaino"
                onClick={() => {
                    handleNavLinkClick("our services.");
                  }}
              >
                <TiArrowRight />
                Our Services{" "}
        ...
        <div className="link_container resources">
          ...
          <ul>
            ...
            <li>
              {" "}
              <a
                href="https://opencorporates.com/companies/ug/80020002502844"
                target="_blank"
                rel="noreferrer"
                aria-label="View Nzainos Legal Registraton Status"
              >
                {" "}
                <TiArrowRight />
                Registration Status{" "}
