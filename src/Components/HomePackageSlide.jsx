  ...
  return (
    <>
      ...
      <p className="whotext paragraphs paratext">
        If you have a dream of exploring East Africa on a budget, Nzaino Travels
        has{" "}
        <Link
          ...
          className="linker"
          aria-label="Find an afffordable travel package for East africa."
        >
          the perfect packages
        </Link>{" "}
        for you. We offer great deals on flights 🛩 accommodation 🏕 and
        activities in various destinations. We also assist with all the itenary
        details for you, from planning to booking to insurance. Have a swipe at
        some of our offers below and contact us today. Let us help you
      ...
      <Link
        ...
        aria-label="View all Exciting East African Travel Packages Nzaino Offers."
        onClick={() => {
          handleLinkClick();
        }}
      >
